...
EXTENSIONS = {
    ...
    "envoy.access_loggers.wasm":                        "@envoy_openssl//source/extensions/access_loggers/wasm:config",
    ...
    # WASM
    #
    "envoy.wasm":                                      "@envoy_openssl//source/extensions/wasm:config",
    ...
    "envoy.filters.http.wasm":                          "@envoy_openssl//source/extensions/filters/http/wasm:config",
    ...
    "envoy.filters.network.wasm":                       "@envoy_openssl//source/extensions/filters/network/wasm:config",
